...
const checks = [
  ...
  [smart.includes("For recommendations, give 3 to 5 specific relevant titles") || smart.includes("For book recommendations, give 3 to 5 specific relevant titles"), "recommendation behaviour is explicit"],
